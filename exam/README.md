...
## 28. Контейнер – ассоциативный список
Ассоциативный список, также известный как **map** - структура данных (построенная на красно-черном дереве), хранящая не просто элемент, а пару ключ-значение, где для каждого ключа ровно одно значение.
